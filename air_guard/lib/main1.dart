...
class _DashboardPageState extends State<DashboardPage>
  ...
  Future<void> _updateBuzzer(bool isOn) async {
    try {
      final url = Uri.parse(
        '$BLYNK_URL/update?token=$BLYNK_AUTH&V2=${isOn ? 1 : 0}',
      );
          ...
          children: [
            Container(
              decoration: BoxDecoration(
                ...
                boxShadow: [
                  BoxShadow(
                    color: const Color(0xFF00FFA3).withOpacity(0.55),
                    blurRadius: 28,
                    spreadRadius: 4,
                  ),
                ],
    ...
    return BottomAppBar(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          gradient: LinearGradient(
            colors: [
              const Color(0xFF0F1419).withOpacity(0.85),
        ...
        child: Row(
          ...
          children: [
            _buildNavButton(Icons.home_rounded, 0, 'Home'),
            _buildNavButton(Icons.devices_other_rounded, 1, 'Devices'),
            const SizedBox(width: 40),
            _buildNavButton(Icons.bar_chart_rounded, 2, 'Reports'),
            _buildNavButton(Icons.person_rounded, 3, 'Profile'),
          ],
        ),
      ),
    );
      ...
      child: Column(
        ...
        children: [
          ...
          Align(
            ...
            child: Text(change, style: const TextStyle(color: Colors.white54)),
          ),
        ],
      ),
    );
                      ...
                      ElevatedButton.icon(
                        onPressed: () {
                          ScaffoldMessenger.of(context).showSnackBar(
                            SnackBar(
                              content: Text('Optimizing ${device.name}…'),
                            ),
                          );
                        },
